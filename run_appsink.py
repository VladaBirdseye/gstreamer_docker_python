...
DEFAULT_PIPELINE = utils.to_gst_string([
    "rtspsrc location=rtsp://aiaccount:yhdSYq8qTS4HZSjb@66.225.150.88:8331/ISAPI/Streaming/Channels/101 num-buffers=100",
...
DEFAULT_PIPELINE = utils.to_gst_string([
    "rtspsrc location=rtsp://aiaccount:yhdSYq8qTS4HZSjb@66.225.150.88:8331/ISAPI/Streaming/Channels/101",
    "rtph264depay",
    "h264parse",
    "avdec_h264",
    "video/x-raw",
...
def extract_buffer(sample: Gst.Sample) -> np.ndarray:
    ...
    removed_dim = np.squeeze(array)  # remove single dimension if exists
    cv2.imwrite("im.png", array)
    return removed_dim
